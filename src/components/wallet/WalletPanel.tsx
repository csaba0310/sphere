...
const PANEL_SHELL = "bg-white dark:bg-[#060606]/40 backdrop-blur-xl overflow-hidden h-full relative lg:border-l lg:border-neutral-100 dark:lg:border-[rgba(255,255,255,0.06)] flex flex-col rounded-2xl";
