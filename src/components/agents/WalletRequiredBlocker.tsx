...
export function WalletRequiredBlocker({ children, agentId, onOpenWallet }: WalletRequiredBlockerProps) {
  ...
  return (
    <div className="h-full flex items-center justify-center bg-white/60 dark:bg-[#060606]/40 backdrop-blur-xl rounded-none md:rounded-3xl lg:rounded-none border-0 md:border md:border-neutral-200 dark:md:border-neutral-800/50 lg:border-0">
