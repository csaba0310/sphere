        ...
        <div className="flex-1 flex flex-col items-center justify-center">
          ...
          >
            ...
            <motion.a
              ...
              className="p-3 rounded-full bg-neutral-200/50 dark:bg-neutral-800/50 hover:bg-neutral-300/50 dark:hover:bg-neutral-700/50 transition-colors group"
            >
              <XIcon className="w-5 h-5 md:w-6 md:h-6 text-neutral-600 dark:text-neutral-400 group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors" />
            </motion.a>
          </motion.div>
        </div>
