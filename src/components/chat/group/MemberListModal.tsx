      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-4 top-20 bottom-8 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-full md:max-w-md md:max-h-[70vh] bg-white dark:bg-modal-bg rounded-2xl shadow-2xl z-[100000] flex flex-col overflow-hidden border border-neutral-200 dark:border-white/10"
          >
            {/* Header */}
            <div className="shrink-0 flex items-center justify-between p-4 border-b border-neutral-200 dark:border-white/10">
              ...
              <button
                onClick={onClose}
                className="p-2 rounded-lg hover:bg-neutral-100 dark:hover:bg-white/8 text-neutral-500 dark:text-white/45 transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
                  ...
                  {sortedMembers.map((member) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="flex items-center gap-3 p-3 rounded-xl bg-neutral-50 dark:bg-white/4 border border-neutral-200 dark:border-white/8"
                      >
                        {/* Avatar */}
                        <div className="shrink-0 w-10 h-10 rounded-lg bg-linear-to-br from-orange-500 to-orange-600 text-white text-sm font-medium flex items-center justify-center">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {member.nametag && (
                              <>
                                <span className="text-xs text-neutral-500 dark:text-white/45">Unicity ID:</span>
                          ...
                          <p className="text-xs text-neutral-500 dark:text-white/45 break-all font-mono mt-1">
                            {member.pubkey}
                          </p>
                        </div>
                              ...
                              {showConfirm ? (
                                ...
                                >
                                  ...
                                  <button
                                    ...
                                    disabled={isKicking}
                                    className="px-2 py-1 text-xs font-medium rounded-lg bg-neutral-200 dark:bg-white/10 hover:bg-neutral-300 dark:hover:bg-neutral-600 text-neutral-700 dark:text-neutral-200 transition-colors"
                                  >
                                    No
                                  </button>
                                </motion.div>
            ...
            {canModerate && (
              <div className="shrink-0 p-4 border-t border-neutral-200 dark:border-white/10 bg-amber-50 dark:bg-amber-900/20">
